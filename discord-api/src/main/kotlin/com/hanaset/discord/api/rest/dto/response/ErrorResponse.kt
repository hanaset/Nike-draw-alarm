...
import com.hanaset.discord.api.exception.DiscordApiException
import com.hanaset.discord.api.exception.ErrorCode
...
class ErrorResponse private constructor(
    ...
    constructor(code: ErrorCode, e: DiscordApiException) : this(code, e.message ?: code.message) {
