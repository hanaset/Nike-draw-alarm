package com.hanaset.discord.common.config
...
@ComponentScan(basePackages = [
    "com.hanaset.discord.common.repository"
])
@EnableJpaRepositories(
        basePackages = ["com.hanaset.discord.common.repository"],
...
class HanaJpaDatabaseConfig(private val mbeanExporter: MBeanExporter) {
    ...
    fun hanaEntityManagerFactory(builder: EntityManagerFactoryBuilder): LocalContainerEntityManagerFactoryBean {
        return builder
                ...
                .packages("com.hanaset.discord.common.entity")
